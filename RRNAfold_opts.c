/*
  ...
  gengetopt -i RRNAFold.ggo --file-name=RRNAfold_opts --include-getopt --default-optional --func-name=RRNAfold_parser --arg-struct-name=RRNAfold_args_info 
...
const char *RRNAfold_args_info_purpose = "Uses vienna RNA folding algorithms to produce secondary structures for RRNA \npackage";

const char *RRNAfold_args_info_usage = "Usage: RRNAFold [options]\n";

const char *RRNAfold_args_info_description = "reads in a set of sequences from a file containing one sequence per line and \nproduces an output file that contains coordinates for the secondary structures \nof each sequence.";

const char *RRNAfold_args_info_help[] = {
  "  -h, --help                Print help and exit",
  "  -V, --version             Print version and exit",
  "\nInput Options:",
  "  Below are command line options which alter the general input behavior of \n  RRNAFold\n",
  "  -i, --input-file=STRING   Path to file containing the sequences to be folded\n                                (default=`input.dat')",
  "\nAlgorithm Options:",
  "  Options taken as inputs to vienna's RNAFold algorithms\n",
  "  -t, --temperature=FLOAT   Temperature passed to the viennaFold secondary \n                              structure algorithm\n                                (default=`30.0')",
  "  -f, --fold-type=INT       Dictates the type of output returned  (default=`1')",
  "\nOutput Options:",
  "  Options for defining the output of RRNAFold\n",
  "  -o, --output-file=STRING  Name of file where secondary structure coordinates \n                              are outputed\n                                (default=`output.dat')",
  "\nIf in doubt our program is right, nature is at fault.\nComments should be sent to bida.john@gmail.com.\n",
    0
};
...
typedef enum {ARG_NO
  ...
  , ARG_INT
  , ARG_FLOAT
} RRNAfold_parser_arg_type;

static
void clear_given (struct RRNAfold_args_info *args_info);
static
void clear_args (struct RRNAfold_args_info *args_info);

static int
RRNAfold_parser_internal (int argc, char * const *argv, struct RRNAfold_args_info *args_info,
                        struct RRNAfold_parser_params *params, const char *additional_error);

static int
RRNAfold_parser_required2 (struct RRNAfold_args_info *args_info, const char *prog_name, const char *additional_error);
...
void clear_args (struct RRNAfold_args_info *args_info)
{
  args_info->input_file_arg = gengetopt_strdup ("input.dat");
  args_info->input_file_orig = NULL;
  args_info->temperature_arg = 30.0;
  args_info->temperature_orig = NULL;
  args_info->fold_type_arg = 1;
  args_info->fold_type_orig = NULL;
  args_info->output_file_arg = gengetopt_strdup ("output.dat");
  args_info->output_file_orig = NULL;
  
}

static
void init_args_info(struct RRNAfold_args_info *args_info)
{


  args_info->help_help = RRNAfold_args_info_help[0] ;
  args_info->version_help = RRNAfold_args_info_help[1] ;
  args_info->input_file_help = RRNAfold_args_info_help[4] ;
  args_info->temperature_help = RRNAfold_args_info_help[7] ;
  args_info->fold_type_help = RRNAfold_args_info_help[8] ;
  args_info->output_file_help = RRNAfold_args_info_help[11] ;
  
}

void
RRNAfold_parser_print_version (void)
{
  printf ("%s %s\n", RRNAFOLD_PARSER_PACKAGE, RRNAFOLD_PARSER_VERSION);
}

static void print_help_common(void) {
  RRNAfold_parser_print_version ();

  if (strlen(RRNAfold_args_info_purpose) > 0)
    printf("\n%s\n", RRNAfold_args_info_purpose);

  if (strlen(RRNAfold_args_info_usage) > 0)
    printf("\n%s\n", RRNAfold_args_info_usage);

  printf("\n");

  if (strlen(RRNAfold_args_info_description) > 0)
    printf("%s\n", RRNAfold_args_info_description);
}

void
RRNAfold_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (RRNAfold_args_info_help[i])
    printf("%s\n", RRNAfold_args_info_help[i++]);
}

void
RRNAfold_parser_init (struct RRNAfold_args_info *args_info)
{
...
void
RRNAfold_parser_params_init(struct RRNAfold_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
RRNAfold_parser_params_create(void)
{
  struct RRNAfold_parser_params *params = 
    (struct RRNAfold_parser_params *)malloc(sizeof(struct RRNAfold_parser_params));
  RRNAfold_parser_params_init(params);  
  return params;
}
...
static void
RRNAfold_parser_release (struct RRNAfold_args_info *args_info)
{
  ...
  free_string_field (&(args_info->fold_type_orig));
...
int
RRNAfold_parser_dump(FILE *outfile, struct RRNAfold_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", RRNAFOLD_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
  ...
  if (args_info->fold_type_given)
    write_into_file(outfile, "fold-type", args_info->fold_type_orig, 0);
...
int
RRNAfold_parser_file_save(const char *filename, struct RRNAfold_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", RRNAFOLD_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = RRNAfold_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
RRNAfold_parser_free (struct RRNAfold_args_info *args_info)
{
  RRNAfold_parser_release (args_info);
}
...
int
RRNAfold_parser (int argc, char * const *argv, struct RRNAfold_args_info *args_info)
{
  return RRNAfold_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
RRNAfold_parser_ext (int argc, char * const *argv, struct RRNAfold_args_info *args_info,
                   struct RRNAfold_parser_params *params)
{
  int result;
  result = RRNAfold_parser_internal (argc, argv, args_info, params, NULL);

  if (result == EXIT_FAILURE)
    {
      RRNAfold_parser_free (args_info);
      exit (EXIT_FAILURE);
    }
...
int
RRNAfold_parser2 (int argc, char * const *argv, struct RRNAfold_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct RRNAfold_parser_params params;
...
int
RRNAfold_parser_required (struct RRNAfold_args_info *args_info, const char *prog_name)
{
  int result = EXIT_SUCCESS;

  if (RRNAfold_parser_required2(args_info, prog_name, NULL) > 0)
    result = EXIT_FAILURE;
 ...
 * @param check_ambiguity @see RRNAfold_parser_params.check_ambiguity
 * @param override @see RRNAfold_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               RRNAfold_parser_arg_type arg_type,
                        ...
                        struct RRNAfold_parser_params *params, const char *additional_error)
{
  ...
  int error = 0;
  struct RRNAfold_args_info local_args_info;
  ...
  if (initialize)
    RRNAfold_parser_init (args_info);

  RRNAfold_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:t:f:o:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          RRNAfold_parser_print_help ();
          RRNAfold_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
        ...
        case 'i':	/* Path to file containing the sequences to be folded\n.  */
        
        
          if (update_arg( (void *)&(args_info->input_file_arg), 
               &(args_info->input_file_orig), &(args_info->input_file_given),
              &(local_args_info.input_file_given), optarg, 0, "input.dat", ARG_STRING,
          ...
          break;
        case 't':	/* Temperature passed to the viennaFold secondary structure algorithm\n.  */
        
        
          if (update_arg( (void *)&(args_info->temperature_arg), 
               &(args_info->temperature_orig), &(args_info->temperature_given),
              &(local_args_info.temperature_given), optarg, 0, "30.0", ARG_FLOAT,
              check_ambiguity, override, 0, 0,
              "temperature", 't',
              additional_error))
            goto failure;
          ...
          break;
        case 'f':	/* Dictates the type of output returned.  */
        
        
          if (update_arg( (void *)&(args_info->fold_type_arg), 
               &(args_info->fold_type_orig), &(args_info->fold_type_given),
              &(local_args_info.fold_type_given), optarg, 0, "1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "fold-type", 'f',
              additional_error))
            goto failure;
          ...
          break;
        case 'o':	/* Name of file where secondary structure coordinates are outputed\n.  */
        
        
          if (update_arg( (void *)&(args_info->output_file_arg), 
               &(args_info->output_file_orig), &(args_info->output_file_given),
              &(local_args_info.output_file_given), optarg, 0, "output.dat", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "output-file", 'o',
              additional_error))
            goto failure;
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", RRNAFOLD_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  if (check_required)
    {
      error += RRNAfold_parser_required2 (args_info, argv[0], additional_error);
    }

  RRNAfold_parser_release (&local_args_info);
